...
const SubmitButton = () => {
  ...
  return (
    <>
      ...
      <Button onClick={() => setSearchParams({ name: QueryParamKey.SIGN_IN, value: '1' })}>login</Button>
      <Button onClick={() => setSearchParams({ name: QueryParamKey.SIGN_UP, value: '1' })}>signup</Button>
      <Button onClick={() => setSearchParams({ name: QueryParamKey.WELCOME, value: '1' })}>welcome</Button>
      <Button
        onClick={() =>
          setSearchParams({
