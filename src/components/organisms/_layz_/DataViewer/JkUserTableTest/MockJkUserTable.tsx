          ...
          (user) =>
            ({
              ...
              dateTest: new Date(
                ...
                new Date().getMonth() + Math.round(Math.random() * 3),
                Math.round(Math.random() * 20 + 1),
                Math.round(Math.random() * 20 + 1),
                Math.round(Math.random() * 50 + 1),
                Math.round(Math.random() * 50 + 1),
              ),
              dateTestRange: new Date(
                new Date().getFullYear(),
                new Date().getMonth() + Math.round(Math.random() * 3),
                Math.round(Math.random() * 20 + 1),
                Math.round(Math.random() * 20 + 1),
      ...
      },
      {
        ...
        Field: ({ record: { status } }) => (
          <div className="jk-table-field">
            ...
            >
              <div className="jk-tag bc-sf-md">{status}</div>
            </Popover>
            <div>
    ...
    () => [
      {
        head: <TextHeadCell text="Name / Nickname" />,
        index: 'name',
        Field: ({ record: { nickname } }) => <FieldText text={nickname} label={<T>name</T>} />,
        sort: true,
        // filter: { type: 'text' },
      ...
      },
      {
        head: <TextHeadCell text="Name / Nickname" />,
        index: 'name-2',
        Field: ({ record: { givenName } }) => <FieldText text={givenName} label="test" />,
        // sort: true,
        // filter: { type: 'text' },
        cardPosition: 'topLeft',
        sticky: false,
