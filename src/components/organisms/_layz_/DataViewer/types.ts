...
export type FilterSelectOfflineType<T> = {
  ...
  callbackFn: (props: { columnIndex: string; selectedOptions: OptionType<string>[] }) => (record: T, index: number) => boolean;
};
...
export type JkTableHeaderFilterType<T> =
  ...
  | FilterTextOfflineType<T>
  | FilterTextAutoOfflineType<T>
  | FilterSelectOnlineType
  | FilterSelectOfflineType<T>
  | FilterSelectAutoOfflineType<T>
  | FilterDateOnlineType
  | FilterDateOfflineType<T>
  | FilterDateAutoOfflineType<T>
  | FilterDateRangeOnlineType
  | FilterDateRangeOfflineType<T>
  | FilterDateRangeAutoOfflineType<T>;
