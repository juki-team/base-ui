  ...
  return (
    <div className="jk-row gap top stretch">
      <div className="jk-col top extend">
        <h3>
          <T className="tt-se">preferences</T>
        </h3>
        <div className="jk-col stretch gap bc-sf-md jk-br-ie jk-pg-md pn-re">
          {loading && <LineLoader />}
            ...
            {[
              {
                ...
                labelFirst: (
                  <div className="jk-row nowrap">
                    <div className="jk-row pn-re" style={{ width: 24, height: 24 }}>
                      <Image alt="US image" width={24} height={18} src="https://images.juki.pub/assets/image-us.png" />
                    </div>
                ...
                labelSecond: (
                  <div className="jk-row nowrap">
                    <div className="jk-row pn-re" style={{ width: 24, height: 24 }}>
                      <Image alt="ES image" width={24} height={18} src="https://images.juki.pub/assets/image-es.png" />
                    </div>
      ...
      <div className="jk-col top extend">
        <h3>
          <T className="tt-se">actions</T>
        </h3>
        <div className="jk-col stretch gap bc-sf-md jk-br-ie jk-pg-md">
            ...
            <div className="jk-row stretch gap space-between block extend">
              <div className="jk-row gap left nowrap">
                <InputToggle
                  ...
                  onChange={(newValue) => setSettings([{ key: ProfileSetting.NEWSLETTER_SUBSCRIPTION, value: newValue }])}
                  leftLabel={
