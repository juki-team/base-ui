    ...
    >
      <div className="jk-col gap left stretch">
        ...
        <div>
          ...
          <span className="jk-tag bc-sf-hi">{previousVersion}</span>&nbsp;
          <T>and the new UI version available is</T>&nbsp;
          <span className="jk-tag bc-sf-hi">{newVersion}</span>.
        </div>
        <div>
          <T className="tt-se">an interface update may mean improvements in the user experience and/or bug fixes.</T>
        </div>
        <div>
