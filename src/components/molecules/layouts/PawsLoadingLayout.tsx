import { Children, type CSSProperties, memo, type PropsWithChildren, useId } from 'react';
...
function PawsLoadingLayoutComponent(props: PawsLoadingLayoutProps) {
  ...
  return (
    <div className="jk-loader-layout expand-absolute pe-ne" ref={ref} style={style}>
      <style>
        {`
...
export const PawsLoadingLayout = memo(PawsLoadingLayoutComponent);
