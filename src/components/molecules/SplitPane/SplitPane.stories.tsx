    ...
    <div style={{ border: '1px solid red', width: 800, height: 1000 }}>
      <SplitPaneComponent toggleOption>
        <div style={{ background: '' }}>
          ...
          <div style={{ height: 200 }}>
            <SplitPaneComponent
              minSize={1} direction="row" closableFirstPane={{ align: 'center' }}
          ...
          <div style={{ height: 200 }}>
            <SplitPaneComponent
              minSize={1} direction="row" closableFirstPane={{ align: 'left' }}
        ...
        <div style={{ background: '' }}>
          ...
          <div style={{ height: 200 }}>
            <SplitPaneComponent
              minSize={1} direction="column" closableFirstPane={{ align: 'right', hideLabel: '' }}
          ...
          <div style={{ height: 200 }}>
            <SplitPaneComponent
              minSize={1} direction="column" closableFirstPane={{ align: 'center' }}
              closableSecondPane={{ align: 'center' }}
            >
              <div style={{ background: 'yellow' }}>A<br />A</div>
              <div style={{ background: 'blueviolet' }}>B</div>
          ...
          <div style={{ height: 200 }}>
            <SplitPaneComponent
              minSize={1} direction="column" closableFirstPane={{ align: 'left' }}
              closableSecondPane={{ align: 'left' }}
            >
              <div style={{ background: 'yellow' }}>A<br />A</div>
              <div style={{ background: 'blueviolet' }}>B</div>
