  ...
  render: (args) => (
    <MockupJukiProvider>
      <div className="jk-col gap nowrap jk-pg-md">
        ...
        <div style={{ outline: '1px solid red', padding: 8 }}><Input {...args} type="password" /></div>
        <div style={{ outline: '1px solid red', padding: 8 }}><Input {...args} type="file" /></div>
        <div style={{ outline: '1px solid red', padding: 8 }}><Input {...args} type="files" /></div>
        <div style={{ outline: '1px solid red', padding: 8 }}><InputPassword {...args as InputPasswordProps<any>} />
        </div>
