    ...
    <Modal className="editor-settings-modal jk-pad-lg" isOpen={isOpen} onClose={onClose} closeIcon>
      <div className="jk-pad jk-col stretch gap">
        ...
        <div className="jk-row left gap">
          <label className="tx-wd-bold text-sentence-case"><T>choose editor style</T>: </label>
          <Select
        ...
        <div className="jk-row left gap">
          <label className="tx-wd-bold text-sentence-case"><T>choose your editor key mapping</T>: </label>
          <Select
        ...
        <div className="jk-row left gap">
          <label className="tx-wd-bold text-sentence-case"><T>choose your tab size</T>: </label>
          <Select
