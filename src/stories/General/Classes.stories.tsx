      ...
      body: (
        <div className="jk-row gap">
          {[
            ...
            <div className="jk-row gap jk-shadow jk-pad jk-border-radius-inline fw-br cr-we" style={{ width: '420px' }}>
      ...
      body: (
        <div className="jk-row gap">
          {[
            ...
            <div className="jk-row gap jk-shadow jk-pad jk-border-radius-inline fw-br cr-we" style={{ width: '320px' }}>
              <pre className="cr-g1">{col}</pre>
